...
class HelpTest < Minitest::Test
  ...
  def test_two_arguments_given_returns_proper_value
    assert_equal "Empties the queue" , Help.give_help("queue clear")
  end

  def test_responds_to_command_that_does_not_exist
    assert_equal "That is not a valid command" , Help.give_help("poop")
    assert_equal "That is not a valid command" , Help.give_help("poop poop")
    assert_equal "That is not a valid command" , Help.give_help("poop poop poop")
  end
